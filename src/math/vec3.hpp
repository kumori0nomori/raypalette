...
struct Vec3 {
  ...
  RAYPALETTE_HOST_DEVICE constexpr Vec3(float x_value, float y_value, float z_value)
...
RAYPALETTE_HOST_DEVICE constexpr Vec3 operator*(const Vec3& left, const Vec3& right) {
...
RAYPALETTE_HOST_DEVICE constexpr Vec3 cross(const Vec3& left, const Vec3& right) {
